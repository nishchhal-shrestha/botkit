                ...
                if (this.processing) {
                    ...
                    if (this.messages.length) {
                        ...
                        if (typeof(this.messages[0].timestamp) == 'undefined' ||
                            ...
                            if(message.setVar) {
                                this.setVar(message.setVar.key, message.setVar.value);
                            }
                            ...
                            if(message.jsonApi) {                    
                                ...
                                message.jsonApi(attributeObjects).then(function(data) {
                                    ...
                                    if (data.customBotkitRequest) {
                                        (async function(data) {
                                            const { success, setVars } = data;
                                            ...
                                            for (let varToSet of varsToSet) {
                                                if (varToSet.key) {
                                                    await that.setVar(varToSet.key, varToSet.value, varToSet.isPersist);
                                                }
                                            }
                                        ...
                                        if (!data.displayMessagesAndAttachments) {
                                            return;
                                        }
                                    }
                            ...
                            if (message.gotoDialogue) {
                                ...
                                ((gotoDialogue) => {
                                    ...
                                    if (!allowRandom) {
                                        ...
                                        this.task.botkit.trigger('message_received', [this.task.bot, message]);
