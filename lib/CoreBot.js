...
function Botkit(configuration) {
    ...
    function Conversation(task, message) {
        ...
        this.setVar = function(field, value, isPersist, format) {
            if (!this.vars) {
                this.vars = {};
            }
            ...
            const formatString = format && format.formatString;
            ...
            if (formatType && formatString) {
                if (formatType === 'Date') {
                    ...
                    if (formattedDate.isValid()) {
                        valueToStore = formattedDate.format(formatString);
                    }
                }
            }

            this.vars[field] = valueToStore;
