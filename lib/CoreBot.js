                        ...
                        if (typeof(this.messages[0].timestamp) == 'undefined' ||
                            ...
                            if(message.jsonApi) {                    
                                ...
                                if (Array.isArray(attributeObjects)) {
                                    attributeObjects = attributeObjects.map((attributeObject) => {
                                        const value = this.getVar(attributeObject.name);
                                ...
                                message.jsonApi(attributeObjects).then(function(data) {
                                    ...
                                    outbound.text = pluginMessages.errorOccured;
                                ...
                                ((gotoDialogue) => {
                                    ...
                                    for (let filter of filters) {
                                        ...
                                        if (logicalOperator.toLowerCase() === 'or') {
                                            ...
                                            if (filter.filterValue === attributeValue) {
